...
pub struct Dict {
    ...
    pub detached_from: &'static str,
    pub screen_exit_code: &'static str,
    ...
    pub attach_title: &'static str,
    pub attach_line: &'static str,
    pub attach_share: &'static str,
    pub attach_takeover: &'static str,
    pub attach_hint: &'static str,
...
const DICT_EN: Dict = Dict {
    ...
    detached_from: "detached from '{0}'",
    screen_exit_code: "screen exited with code {0} ({1})",
    ...
    multi_note: "multi-display session: terminals may resize each other",
    ...
    inside_sty: "already inside a screen session ($STY); nested connections can be confusing",
    ...
    attach_title: " Attached ",
    attach_line: " '{0}' is attached",
    attach_share: "share (-x)",
    attach_takeover: "takeover (-d -r)",
    attach_hint: " 1/2 choose · Esc cancel",
...
const DICT_ZH: Dict = Dict {
    ...
    detached_from: "已从 '{0}' 断开",
    screen_exit_code: "screen 退出码 {0}（{1}）",
    ...
    inside_sty: "已在一个 screen 会话内（$STY）；嵌套连接容易混淆",
    ...
    attach_line: " '{0}' 已被连接",
    attach_share: "共享（-x）",
    attach_takeover: "接管（-d -r）",
    attach_hint: " 1/2 选择 · Esc 取消",
